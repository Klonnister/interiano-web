...
export const primeVueOptions: PrimeVueConfiguration = {
  pt: {
    inputtext: {
      root: 'bg-[#061321] text-[#dae0f5] py-2.5 px-4 text-base rounded-md border-0 w-full local-inset-shadow disabled:opacity-60 transition-all duration-300 ease-in-out',
    },
